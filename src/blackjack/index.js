/*
import {crearDeck} from './usecase/crear-deck';
...
btnPedir.addEventListener('click', () => {
    ...
    if ( puntosJugador > 21 ) {
        ...
        turnoComputadora( puntosJugador,deck, puntosHTML[1],divCartasComputadora  );//, puntosComputadora
...
btnNuevo.addEventListener('click', () => {
    ...
    console.clear();
    deck = [];
    deck = crearDeck(tipos,especiales);//originalmente vacio
